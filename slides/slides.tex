...
\begin{frame}[fragile]
  ...
  \begin{columns}
   \begin{column}{0.5\textwidth}
     \begin{enumerate}
     	\item Every Mux in CLB is Programmable
	\item Look Up table is configured with LUT Mask from part of  complex expression 
	\item which internally have Muxes (for 4 input lut - 16:1 Mux can be used )
     \end{enumerate}
    \end{column}
% Column 2    
   \begin{column}{0.5\textwidth}		
